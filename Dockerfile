...
# Use CUDA 12.1 for better compatibility with newer models
FROM nvidia/cuda:12.1.0-devel-ubuntu22.04

ENV DEBIAN_FRONTEND=noninteractive

# Install Python, pip, git, ffmpeg (for video processing utils)
...
# Install xformers for better performance on NVIDIA GPUs
